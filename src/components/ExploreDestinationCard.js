    ...
    <div className=''>
      <div className="  pt-3 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
        <div className="rounded overflow-hidden shadow-lg">
          <img className="w-full h-[200px]" src="https://i.ytimg.com/vi/VhpIJ6eGQeE/maxresdefault.jpg" alt="Mountain"/>
        ...
        <div className="rounded overflow-hidden shadow-lg">
          <img className="w-full h-[200px]" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHsQoNYnIaAfDFxECovwVBpcT-1JqAU_imlg&usqp=CAU" alt="River"/>
            <div className="px-6 py-4">
        ...
        <div className="rounded overflow-hidden shadow-lg">
          <img className="w-full h-[200px]" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMmC7YfSHDzW10-wgfyXlHHZHtsM4vC57L6Q&usqp=CAU" alt="Forest" />
          <div className="px-6 py-4">

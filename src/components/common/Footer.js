    ...
    <>
      <footer className="text-center  bg-[#ff7400] text-white">
        ...
        <div className="text-center p-4 text-sm" style={{backgroundColor: 'rgba(0, 0, 0, 0.2)'}} >
          ...
          <span className='text-xs'>Created by: <a className='ml-1 underline text-sm' target="_blank" rel="noreferrer" href="http://krishnaakhanal.com.np/">Krishna Khanal</a> </span>
        </div>                                                                                                                                                                                                                                                                
      </footer>                                                                                                                                                       
                                            </>
                                          )

      ...
      <footer className="text-center  bg-[#ff7400] text-white">
        <div className=" px-6 pt-6 mx-auto">
          <div className="flex justify-center mb-6">
            ...
            <NavLink to="facebook.com" type="button" className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
              <svg aria-hidden="true"
                focusable="false"
                data-prefix="fab"
                data-icon="twitter"
            ...
            <form action="">
              ...
              "
                ...
                <div className="md:mr-auto mb-6">
                  <button type="submit" className="inline-block px-6 py-2 border-2 border-white text-white font-medium text-xs leading-tight uppercase  hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                    Subscribe
                  </button>
                </div>
              </div>
        ...
        <div className="text-center p-4 text-sm" style={{backgroundColor: 'rgba(0, 0, 0, 0.2)'}} >
          ...
          <span className='text-xs'>Created by: <a className='ml-1 underline text-sm' href="http://krishnaakhanal.com.np/" target="_blank" rel="noopener noreferrer">Krishna Khanal</a> </span>
        </div>                                                                                                                                                                                                                                                                
      </footer>                                                                                                                                                       
                                            </>
                                          )

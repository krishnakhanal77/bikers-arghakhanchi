    ...
    <>
        ...
        <div className='xl:w-[70%] lg:w-[80%]  md:w-[80%] xs:w-[95%] m-auto' >
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
            <div className=' xs:order-2 sm:mt-[4rem] md:mt-[8rem] text-white'>
              <h1 className='sm:font-medium sm:text-[2rem] md:font-semibold md:text-[4rem] md:leading-[4.5rem]' >Boost your <br /> Power Now!! bhujis</h1>
          ...
          <div className='text-white py-12' >
            <h1 className='mb-8 text-4xl font-bold text-center text-accent'>Blogs</h1>
            <Slide />
          </div>
        </div>
      </div>
      <section className="bg-primary-dark py-12">
        <div className='md:w-[80%] xs:w-[95%] m-auto'>
          <h1 className='mt-8 font-medium text-center text-4xl text-accent'>Explore Our Nearest Destinations</h1>
